...
class TestSequenceFunctions(unittest.TestCase):  # pylint: disable=R0904
    ...
    def setUp(self):
        ...
        file_rel = os.path.join(
            CLTK_DATA_DIR, "grc", "model", "grc_models_cltk", "README.md"
        )
        ...
        file_rel = os.path.join(
            CLTK_DATA_DIR, "lat", "model", "lat_models_cltk", "README.md"
        )
        file = os.path.expanduser(file_rel)
        file_exists = os.path.isfile(file)
        self.assertTrue(file_exists)
        ...
        file_rel = os.path.join(
            CLTK_DATA_DIR, "fro", "model", "fro_models_cltk", "README.md"
        )
        file = os.path.expanduser(file_rel)
        file_exists = os.path.isfile(file)
        self.assertTrue(file_exists)
        ...
        file_rel = os.path.join(
            CLTK_DATA_DIR, "non", "model", "non_models_cltk", "README.md"
        )
        file = os.path.expanduser(file_rel)
        file_exists = os.path.isfile(file)
        self.assertTrue(file_exists)
        ...
        file_rel = os.path.join(
            CLTK_DATA_DIR, "gml", "model", "gml_models_cltk", "README.md"
        )
        file = os.path.expanduser(file_rel)
        file_exists = os.path.isfile(file)
        self.assertTrue(file_exists)
        ...
        file_rel = os.path.join(
            CLTK_DATA_DIR, "ang", "model", "ang_models_cltk", "README.md"
        )
        file = os.path.expanduser(file_rel)
        file_exists = os.path.isfile(file)
        self.assertTrue(file_exists)
        ...
        file_rel = os.path.join(
            CLTK_DATA_DIR, "gmh", "model", "gmh_models_cltk", "README.md"
        )
        file = os.path.expanduser(file_rel)
