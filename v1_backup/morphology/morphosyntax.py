...
def from_ud(
    ...
    if feature_name in FORM_UD_MAP:
        ...
        msg2: str = "If you believe this is not an error in the dependency parser, please raise an issue at <https://github.com/cltk/cltk/issues> and include a short text to reproduce the error."
        print(msg1)
        print(msg2)
        print("")
