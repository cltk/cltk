...
class TLGU:
    ...
    def _check_and_download_tlgu_source(self) -> None:
        ...
        if not os.path.isfile(path):
            dl_msg: str = "This part of the CLTK depends upon TLGU, software written by Dimitri Marinakis `<http://tlgu.carmen.gr/>`_."
            print(dl_msg)
            ...
            if do_download:
                ...
                raise CLTKException("TLGU software required for this class to work.")
