...
texts_to_remove_from_fileids = ["index.txt", "indices.txt"]

# ontology map directories

corpus_directories_by_type = {
    "republican": ["./caesar", "./lucretius", "./nepos", "./cicero"],
    "augustan": ["./livy", "./ovid", "./horace", "./vergil", "./hyginus"],
    "early_silver": [
        "./martial",
        "./juvenal",
        "./tacitus",
...
corpus_texts_by_type = {
    ...
    "early": ["12tables.txt"],
    "medieval": ["anselmepistula.txt", "anselmproslogion.txt", "carm.bur.txt"],
    "christian": [
        "anon.martyrio.txt",
        "benedict.txt",
        "berengar.txt",
    ...
    "renaissance": ["petrarch.ep1.txt", "petrarch.numa.txt", "petrarch.rom.txt"],
    "neo_latin": [
        "spinoza.ethica1.txt",
        "spinoza.ethica2.txt",
        "spinoza.ethica3.txt",
