...
class TestSequenceFunctions(unittest.TestCase):  # pylint: disable=R0904
    ...
    def setUp(self):
        ...
        file_rel = os.path.join(
            CLTK_DATA_DIR, "old_norse/model/old_norse_models_cltk/README.md"
        )
        file = os.path.expanduser(file_rel)
        file_exists = os.path.isfile(file)
        self.assertTrue(file_exists)
        ...
        file_rel = os.path.join(
            CLTK_DATA_DIR,
            "middle_low_german/model/middle_low_german_models_cltk/README.md",
        )
        file = os.path.expanduser(file_rel)
        file_exists = os.path.isfile(file)
        self.assertTrue(file_exists)
        ...
        file_rel = os.path.join(
            CLTK_DATA_DIR, "old_english/model/old_english_models_cltk/README.md"
        )
        file = os.path.expanduser(file_rel)
        file_exists = os.path.isfile(file)
        self.assertTrue(file_exists)
    ...
    def test_check_latest_latin(self):
        """Test _check_latest_data()"""
        path = CLTK_DATA_DIR, "latin/model/latin_models_cltk"
        # p = CLTK_DATA_DIR, 'latin/model/latin_models_cltk/ner/proper_names.txt'
