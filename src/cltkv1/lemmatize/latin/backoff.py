...
from cltkv1.lemmatize.latin.latin import latin_pps, latin_sub_patterns, rn_patterns
...
if __name__ == "__main__":
    ...
    l2 = DictLemmatizer(
        lemmas={"arma": "arma", "uirum": "uir"}, backoff=l1, verbose=True
    )
    l3 = UnigramLemmatizer(
        train=[[("cano", "cano"), (".", "punc")]], backoff=l2, verbose=True
    )
    l4 = RegexpLemmatizer(
        regexps=[("(.)tat(is|i|em|e|es|um|ibus)$", r"\1tas")], backoff=l3, verbose=True
    )
