...
from cltkv1.stem.akkadian.syllabifier import AKKADIAN
        ...
        for char in word:
            if char in self.akkadian["consonants"]:
                ...
                if char in self.akkadian["macron_vowels"]:
                    char = self.akkadian["short_vowels"][
                        self.akkadian["macron_vowels"].index(char)
                    ]
                elif char in self.akkadian["circumflex_vowels"]:
                    char = self.akkadian["short_vowels"][
                        self.akkadian["circumflex_vowels"].index(char)
                    ]
