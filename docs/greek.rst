...
.. Warning:: Beware **this function will filter out anything that doesn't figure in the Greek/Coptic, and Greek Extended Unicode blocks and also some characters which are found in those blocks**. This means integers like 1-9 or punctuations like ".," and symbols like "ϓ,ϐ" will be filtered out. However, it conserves whitespace and newline character.
