...
Clausulae Analysis
==================
Clausulae analysis is an integral part of Latin prosimetrics. The clausulae analysis module analyzes prose rhythm data generated by the prosody module to produce a dictionary of common rhythm types and their frequencies. The list of clausulae for which the module tallies frequencies is derived from the list provided in John Ramsey's Cambridge commentary on Cicero's First and Second Philippic.
