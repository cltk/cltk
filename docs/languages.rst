...
.. code-block:: python
   ...
   >>> a_pipeline.language
   Language(name='Akkadian', glottolog_id='akka1240', latitude=33.1, longitude=44.1, dates=[], family_id='afro1255', parent_id='east2678', level='language', iso='akk', type='a')
...
.. code-block:: python
   ...
   >>> a_pipeline.language
   Language(name='Standard Arabic', glottolog_id='stan1318', latitude=27.9625, longitude=43.8525, dates=[], family_id='afro1255', parent_id='arab1395', level='language', iso='arb', type='')
   >>> a_pipeline.language.name
   'Standard Arabic'
   >>> a_pipeline.processes
...
.. code-block:: python
   ...
   >>> a_pipeline.language
   Language(name='Official Aramaic (700-300 BCE)', glottolog_id='', latitude=0.0, longitude=0.0, dates=[], family_id='', parent_id='', level='', iso='arc', type='a')
   >>> a_pipeline.language.name
...
.. code-block:: python
   ...
   >>> a_pipeline.language
   Language(name='Literary Chinese', glottolog_id='lite1248', latitude=0.0, longitude=0.0, dates=[], family_id='sino1245', parent_id='clas1255', level='language', iso='lzh', type='h')
   >>> a_pipeline.language.name
   'Literary Chinese'
   >>> a_pipeline.processes
...
.. code-block:: python
   ...
   >>> a_pipeline.language
   Language(name='Coptic', glottolog_id='copt1239', latitude=29.472, longitude=31.2053, dates=[], family_id='afro1255', parent_id='egyp1245', level='language', iso='cop', type='')
   >>> a_pipeline.language.name
   'Coptic'
   >>> a_pipeline.processes
...
.. code-block:: python
   ...
   >>> a_pipeline.language
   Language(name='Gothic', glottolog_id='goth1244', latitude=46.9304, longitude=29.9786, dates=[], family_id='indo1319', parent_id='east2805', level='language', iso='got', type='a')
   >>> a_pipeline.language.name
   'Gothic'
   >>> a_pipeline.processes
...
.. code-block:: python
   ...
   >>> a_pipeline.language
   Language(name='Ancient Greek', glottolog_id='anci1242', latitude=39.8155, longitude=21.9129, dates=[], family_id='indo1319', parent_id='east2798', level='language', iso='grc', type='h')
   >>> a_pipeline.language.name
   'Ancient Greek'
   >>> a_pipeline.processes
...
.. code-block:: python
   ...
   >>> a_pipeline.language
   Language(name='Hindi', glottolog_id='hind1269', latitude=25.0, longitude=77.0, dates=[], family_id='indo1319', parent_id='hind1270', level='language', iso='hin', type='')
   >>> a_pipeline.language.name
   'Hindi'
   >>> a_pipeline.processes
...
.. code-block:: python
   ...
   >>> a_pipeline.language
   Language(name='Latin', glottolog_id='lati1261', latitude=41.9026, longitude=12.4502, dates=[], family_id='indo1319', parent_id='impe1234', level='language', iso='lat', type='a')
   >>> a_pipeline.language.name
   'Latin'
   >>> a_pipeline.processes
...
.. code-block:: python
   ...
   >>> a_pipeline.language
   Language(name='Middle High German', glottolog_id='midd1343', latitude=0.0, longitude=0.0, dates=[], family_id='indo1319', parent_id='midd1349', level='language', iso='gmh', type='h')
   >>> a_pipeline.language.name
   'Middle High German'
   >>> a_pipeline.processes
...
.. code-block:: python
   ...
   >>> a_pipeline.language
   Language(name='Old English (ca. 450-1100)', glottolog_id='olde1238', latitude=51.06, longitude=-1.31, dates=[], family_id='indo1319', parent_id='angl1265', level='language', iso='ang', type='h')
   >>> a_pipeline.language.name
...
.. code-block:: python
   ...
   >>> a_pipeline.language
   Language(name='Middle English', glottolog_id='midd1317', latitude=0.0, longitude=0.0, dates=[], family_id='indo1319', parent_id='merc1242', level='language', iso='enm', type='h')
   >>> a_pipeline.language.name
   'Middle English'
   >>> a_pipeline.processes
...
.. code-block:: python
   ...
   >>> a_pipeline.language
   Language(name='Old French (842-ca. 1400)', glottolog_id='oldf1239', latitude=0.0, longitude=0.0, dates=[], family_id='indo1319', parent_id='oila1234', level='language', iso='fro', type='h')
   >>> a_pipeline.language.name
...
.. code-block:: python
   ...
   >>> a_pipeline.language
   Language(name='Middle French', glottolog_id='midd1316', latitude=0.0, longitude=0.0, dates=[], family_id='indo1319', parent_id='stan1290', level='dialect', iso='frm', type='h')
   >>> a_pipeline.language.name
   'Middle French'
   >>> a_pipeline.processes
...
.. code-block:: python
   ...
   >>> a_pipeline.language
   Language(name='Church Slavic', glottolog_id='chur1257', latitude=43.7171, longitude=22.8442, dates=[], family_id='indo1319', parent_id='east2269', level='language', iso='chu', type='a')
   >>> a_pipeline.language.name
   'Church Slavic'
   >>> a_pipeline.processes
...
.. code-block:: python
   ...
   >>> a_pipeline.language
   Language(name='Old Norse', glottolog_id='oldn1244', latitude=63.42, longitude=10.38, dates=[], family_id='indo1319', parent_id='west2805', level='language', iso='non', type='h')
   >>> a_pipeline.language.name
   'Old Norse'
   >>> a_pipeline.processes
...
.. code-block:: python
   ...
   >>> a_pipeline.language
   Language(name='Pali', glottolog_id='pali1273', latitude=24.5271, longitude=82.251, dates=[], family_id='indo1319', parent_id='biha1245', level='language', iso='pli', type='a')
   >>> a_pipeline.language.name
   'Pali'
   >>> a_pipeline.processes
...
.. code-block:: python
   ...
   >>> a_pipeline.language
   Language(name='Eastern Panjabi', glottolog_id='panj125', latitude=30.0368, longitude=75.6702, dates=[], family_id='indo1319', parent_id='east2727', level='language', iso='pan', type='')
   >>> a_pipeline.language.name
   'Eastern Panjabi'
   >>> a_pipeline.processes
   [<class 'cltk.tokenizers.processes.MultilingualTokenizationProcess'>, <class 'cltk.stops.processes.StopsProcess'>]
...
.. code-block:: python
   ...
   >>> a_pipeline.language
   Language(name='Sanskrit', glottolog_id='sans1269', latitude=20.0, longitude=77.0, dates=[], family_id='indo1319', parent_id='indo1321', level='language', iso='san', type='a')
   >>> a_pipeline.language.name
   'Sanskrit'
   >>> a_pipeline.processes
