...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def test_string_stop_list_inc_counts(self):
        ...
        stoplist = StringStoplist('latin').build_stoplist(test_1, inc_counts=True)
        self.assertEqual(stoplist, target_list)        
    ...
    def test_corpus_stop_list_freq(self):
        ...
        stoplist = S.build_stoplist(test_corpus, size=10, basis='frequency')       
        self.assertEqual(stoplist, target_list)        
    ...
    def test_corpus_stop_list_freq_exclude(self):
        ...
        S = CorpusStoplist('latin')
        stoplist = S.build_stoplist(test_corpus, size=10, basis='frequency', exclude=['ad'])       
        self.assertEqual(stoplist, target_list)   
    ...
    def test_corpus_stop_list_freq_include(self):
        ...
        S = CorpusStoplist('latin')
        stoplist = S.build_stoplist(test_corpus, size=10, basis='frequency', include=['est'])       
        self.assertEqual(stoplist, target_list)            
    ...
    def test_corpus_stop_list_freq_sort_words(self):
        ...
        S = CorpusStoplist('latin')
        stoplist = S.build_stoplist(test_corpus, size=10, basis='frequency', sort_words=False)
        self.assertEqual(stoplist, target_list)        
