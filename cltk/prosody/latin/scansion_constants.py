...
class ScansionConstants:
    ...
    def __init__(self, unstressed="U", stressed="-", optional_terminal_ending="X", separator="|"):
        ...
        self.DIPTHONGS = ["ae", "au", "ei", "oe", "ui", "Ui", "uī",
        ...
        self.PREFIXES = ['contrā', 'contra', 'subter', 'circum', 'trans', 'extro', 'suprā', 'extrā',
                         ...
                         'sin', 'per', 'pro', 'abs', 'sub', 'dis', 'dīs', 'con', 'dif', 'non',
                         'sīn', 'prō', 'com', 'tra', 'red', 'sur', 'nōn', 'ob', 'ēr', 'de', 'ex',
