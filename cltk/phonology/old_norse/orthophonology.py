...
# θ = Consonant(Place.dental, Manner.frictative, Voiced.neg, "θ")
th = Consonant(Place.dental, Manner.fricative, Voiced.neg, "θ", Geminate.neg)
# ð = Consonant(Place.dental, Manner.frictative, Voiced.pos, "ð")
...
consonants = [
    b, d, f, g, gh, h, j, k, l, m, n, p, r, s, t, v, th, dh
]

vowels = [
    a, ee, e, oee, oe, i, y, ao, oo, o, u
]
...
digraphs_ipa = {consonant.ipa+consonant.ipa: consonant.geminate() for consonant in consonants}
