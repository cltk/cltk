...
from cltk.corpus.ottoman_turkish.corpora import OTTOMAN_TURKISH_CORPORA
...
AVAILABLE_LANGUAGES = ['arabic', 'chinese', 'coptic', 'greek', 'hebrew', 'latin', 'multilingual',
                       ...
                       'french', 'gujarati', 'middle_high_german','ottoman-turkish_corpora']
...
LANGUAGE_CORPORA = {'arabic': ARABIC_CORPORA,
                    ...
                    'ottoman-turkish_corpora':OTTOMAN_TURKISH_CORPORA
                    }
