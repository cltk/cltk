...
class Synset(_WordNetObject):
    ...
    def __init__(self, wordnet_corpus_reader, language, pos, offset, gloss, semfield=None):
        self._wordnet_corpus_reader = wordnet_corpus_reader
...
class WordNetICCorpusReader(CorpusReader):
    ...
    """
    def __init__(self, root=os.path.join(get_cltk_data_dir(), 'latin/model/latin_models_cltk/semantics/wordnet/'), fileids=None):
