__author__ = ['Kyle P. Johnson <kyle@kyle-p-johnson.com>', 'Dilshan Abeysinghe <maradilshan@gmail.com>']
...
def letters_converter(text, reverse=False):
    ...
    for char_tonos, char_oxia in letters.items():
        if not reverse:        
