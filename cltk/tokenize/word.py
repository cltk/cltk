...
class WordTokenizer:  # pylint: disable=too-few-public-methods
    ...
    def __init__(self, language):
        ...
        if self.language == 'latin':
          ...
          cum_exceptions = cum_exceptions + ['actiacum', 'amicum', 'amycum', 'anticum', 'arcum', 'argolicum', 'cacum', 'caecum', 'cappadocum', 'cilicum', 'circum', 'cornicum', 'coruscum', 'crocum', 'cupencum', 'ducum', 'fatidicum', 'focum', 'glaucum', 'horrificum', 'inicum', 'inimicum', 'iocum', 'iuuencum', 'iuvencum', 'lacum', 'laticum', 'libycum', 'locum', 'lucum', 'magnificum', 'meretricum', 'metiscum', 'modicum', 'nutricum', 'oblicum', 'opacum', 'phaeacum', 'phoenicum', 'priscum', 'propincum', 'pudicum', 'quercum', 'quicum', 'raucum', 'saetacum', 'salaminiacum', 'scythicum', 'siccum', 'silicum', 'tabificum', 'thessalicum', 'truncum', 'uiscum', 'uncum', 'uocum', 'viscum', 'vocum'] # checked against lucan, propertius, tibullus, ovid (elegy), virgil (aeneid)
